import { commands, window, ExtensionContext, ViewColumn } from 'vscode'

import { elementUiList } from './components'
import { IQuickPickItem } from './types'
        ...
        if (res) {
          ...
          panel.webview.html = `
          		...
          		<title>Element UI</title>
						...
						<body>
							<iframe style="position: absolute;border: none;left: 0;top: 0;width: 100%;height: 100%; background: #fff;" src="${`https://element.eleme.cn/#/zh-CN/component/${
                res?.path || 'installation'
              }`}"></iframe>
						</body>
						</html>`
        }
